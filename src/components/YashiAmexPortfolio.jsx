      ...
      <header className="bg-[#016FD0] text-white py-20 h-screen flex items-center relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="space-x-4">
            ...
            <a href={`${import.meta.env.BASE_URL}assets/Yadav_Yashi_resume.pdf`} download className="bg-transparent text-white font-bold py-2 px-6 rounded-full hover:bg-white hover:bg-opacity-20 transition duration-300 border-2 border-white">
              Download Resume
            </a>
          </div>
        </div>
